...
const cardTypes = [
  {
    ...
    features: [
      ...
      "Trả góp 0% tại hàng nghìn đối tác",
    ],
    fee: "Miễn năm đầu",
  ...
  },
  {
    ...
    features: [
      "Ưu đãi giáo dục, y tế, bảo hiểm",
      "Chăm sóc sắc đẹp & siêu thị",
      "Miễn phí thường niên năm đầu",
    ],
    fee: "Miễn năm đầu",
  ...
  },
  {
    ...
    features: [
      "Thêm điểm khi mua sắm siêu thị",
      "Miễn phí thường niên khi đạt 50 triệu/năm",
      "Thu nhập từ 4,5 triệu/tháng",
    ],
  ...
  },
  {
    ...
    features: [
      "Dặm tích khi đi Vietnam Airlines",
  ...
  },
  {
    ...
    features: [
      "Miễn phí 1 triệu ATM toàn thế giới",
      "Thu nhập từ 4,5 triệu/tháng",
      "Miễn phí thường niên năm đầu",
    ],
    fee: "Miễn năm đầu",
  ...
  },
  {
    ...
    features: [
      "Ưu đãi đặc biệt tại Trung Quốc",
      "Thu nhập từ 4,5 triệu/tháng",
      "Miễn phí thường niên năm đầu",
    ],
    fee: "Miễn năm đầu",
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-4 py-14 lg:py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-green-100 text-lg mb-6 leading-relaxed">
              Không cần đến ngân hàng. Chỉ cần CCCD, điền form online và nhận
              kết quả ngay. Hoàn tiền lên đến 15%, hạn mức đến 500 triệu đồng.
            </p>
            ...
            <p className="text-green-200 text-sm mt-4">
              ✓ Miễn phí thường niên năm đầu &nbsp;·&nbsp; ✓ Không cần chứng
              minh thu nhập bằng giấy tờ
            </p>
          </div>
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-sm bg-green-800 rounded-2xl p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={s.label} className="bg-green-700/60 rounded-xl p-4">
                    ...
                    <div className="text-green-300 text-xs mt-1 leading-snug">
                      {s.label}
                    </div>
                  </div>
                ))}
              ...
              <p className="text-green-400 text-xs text-center border-t border-green-700 pt-4">
                Không cần đến ngân hàng · Kết quả trong 10 phút
              </p>
            </div>
          </div>
        </div>
            ...
            {cardTypes.map((card) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  <span
                    className={`absolute bottom-3 left-3 ${card.tagColor} text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide`}
                  >
                    {card.tag}
                  </span>
                </div>
      ...
      <section id="huong-dan" className="bg-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-10">
            Hoàn tất đăng ký trong dưới 5 phút
          </p>
      ...
      <section className="bg-green-50 py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-500 text-center mb-8">
            Điều kiện đơn giản, phù hợp với hầu hết mọi người
          </p>
          <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm">
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 text-sm text-gray-500">
              ...
              Giấy tờ tùy thân 2 mặt (chụp ảnh rõ nét), ảnh selfie cầm giấy tờ.
              Không cần sao kê lương bản gốc khi đăng ký online.
            </div>
          </div>
        </div>
      </section>
